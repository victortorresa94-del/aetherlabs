...
export default function LabsSection() {
  return (
    <section id="servicios" className="v5-section" style={{ backgroundColor: 'var(--v5-bg-surface)' }}>
              ...
              {lab.large && (
                <div style={{
                  ...
                  <div style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'repeating-linear-gradient(135deg, transparent 0px, transparent 38px, rgba(99,102,241,0.04) 38px, rgba(99,102,241,0.04) 40px)',
