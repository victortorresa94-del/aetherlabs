  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Light diffusion — soft diagonal highlight */}
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(130deg, rgba(255,252,245,0.35) 0%, transparent 45%, rgba(180,155,120,0.15) 100%)',
        }} />
        ...
        <div style={{
          ...
          <div style={{ width: '32px', height: '1px', background: 'rgba(80,64,44,0.25)' }} />
        </div>
      </div>
