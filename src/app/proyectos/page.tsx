...
export default function ProyectosPage() {
  const projects = [
    ...
    },
    {
      ...
      description: 'Proyecto integral de branding y dirección de arte generado con IA. Desde el naming y logotipo hasta el universo visual y assets de marca.',
      technologies: ['IA Generativa', 'Branding', 'Dirección de Arte'],
      deliverables: [
        'Identidad Visual',
        'Manual de Marca',
