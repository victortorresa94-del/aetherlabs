      ...
      <section className="min-h-screen flex items-center justify-center bg-black pt-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="flex flex-col space-y-8">
            <span className="text-white/60 font-mono font-bold tracking-[0.2em] uppercase text-sm">
              Arquitectura Humana
            </span>
      ...
      <section className="bg-white dark:bg-black pt-48 pb-24 overflow-hidden">
        <div className="w-full px-6 md:px-12">
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 max-w-[1800px] mx-auto">
            ...
            <div className="pb-4">
              <Link href="/contacto" className="group flex items-center gap-3 text-sm font-bold tracking-[0.2em] text-slate-900 dark:text-white uppercase transition-all bg-white/20 px-6 py-4 rounded-full text-black hover:scale-105 duration-300">
                Charlar ahora
          ...
          <div className="relative bg-black rounded-[40px] p-12 lg:p-24 overflow-hidden shadow-2xl border border-white/5 w-full">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12 max-w-[1600px] mx-auto">
              ...
              {/* Step 2 */}
              <div className="flex flex-col gap-8 group">
                <div className="w-16 h-16 bg-white/10 border border-[#82ff1f]/20 rounded-2xl flex items-center justify-center transition-all group-hover:bg-white/20 shadow-[0_0_20px_rgba(130,255,31,0.15)]">
                  <span className="text-white/60 font-bold text-xl">02</span>
                </div>
                <div>
              ...
              <div className="flex flex-col gap-8 group relative">
                <div className="absolute -inset-8 bg-white/10 rounded-[40px] blur-3xl opacity-30"></div>
                <div className="relative w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center shadow-[0_0_35px_rgba(130,255,31,0.6)] animate-pulse">
                  <span className="text-black font-black text-xl">03</span>
                </div>
                <div className="relative">
                  <h3 className="text-white/60 font-bold text-xl uppercase tracking-[0.2em] mb-4 flex items-center gap-3">
                    Sistema
                    <span className="w-3 h-3 rounded-full bg-white/20 animate-ping"></span>
                  </h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="aspect-square bg-black p-12 flex flex-col justify-between group overflow-hidden relative border-r border-[#82ff1f]/10">
            <div className="z-10 relative">
              <span className="text-white/60 font-mono font-bold text-xs tracking-widest uppercase mb-4 block">Founder</span>
          ...
          <div className="aspect-square bg-white p-12 flex flex-col justify-between group overflow-hidden relative border-r border-zinc-100">
            <div className="z-10 relative">
              <span className="text-white/60 font-mono font-bold text-xs tracking-widest uppercase mb-4 block">Operation</span>
          ...
          <div className="aspect-square bg-black p-12 flex flex-col justify-between group overflow-hidden relative border-r border-[#82ff1f]/10">
            <div className="z-10 relative">
              <span className="text-white/60 font-mono font-bold text-xs tracking-widest uppercase mb-4 block">Commercial</span>
          ...
          <div className="aspect-square bg-white p-12 flex flex-col justify-between group overflow-hidden relative">
            <div className="z-10 relative">
              <span className="text-white/60 font-mono font-bold text-xs tracking-widest uppercase mb-4 block">Technology</span>
      ...
      <section className="bg-black py-40 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-light text-white leading-tight tracking-tight">
            Creemos que el orden no es un estado, sino una <span className="font-instrument italic text-white/60 text-[1.1em]">disciplina</span>. Nuestra misión es dotar a las compañías de la estructura necesaria para que la genialidad humana sea <span className="text-white/40">escalable por diseño.</span>
          </h2>
