        ...
        <main className="v5-page min-h-screen bg-black text-[#F5F5F5]">
            ...
            <section className="relative pt-40 pb-20 overflow-hidden bg-black text-center">
                <div className="v5-container relative z-10 max-w-4xl mx-auto flex flex-col items-center">
                    <span className="v5-label mb-6" style={{ color: '#999999' }}>NUESTRA METODOLOGÍA</span>
                ...
                <div className="v5-container max-w-5xl">
                    <div className="space-y-16">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start p-8 md:p-12 border border-white/10 rounded-3xl bg-black">
                            ...
                            <div>
                                <span className="text-white/60 font-mono tracking-widest text-sm uppercase mb-3 block">EJE 1</span>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start p-8 md:p-12 border border-white/10 rounded-3xl bg-black">
                            <div className="w-24 h-24 shrink-0 rounded-full bg-white/5 border border-white/10 flex justify-center items-center text-4xl">🛠</div>
                            <div>
                                <span className="text-white/60 font-mono tracking-widest text-sm uppercase mb-3 block">EJE 2</span>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start p-8 md:p-12 border border-white/10 rounded-3xl bg-black">
                            <div className="w-24 h-24 shrink-0 rounded-full bg-white/5 border border-white/10 flex justify-center items-center text-4xl">🚀</div>
                            <div>
                                <span className="text-white/60 font-mono tracking-widest text-sm uppercase mb-3 block">EJE 3</span>
                ...
                <div className="v5-container">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-8 border-l border-white/10">
                            <h4 className="font-mono text-white/60 mb-2 font-bold text-sm tracking-widest">SAGA 2025</h4>
                        ...
                        <div className="p-8 border-l border-white/10">
                            <h4 className="font-mono text-white/60 mb-2 font-bold text-sm tracking-widest">EBBINGHAUS</h4>
                        ...
                        <div className="p-8 border-l border-white/10">
                            <h4 className="font-mono text-white/60 mb-2 font-bold text-sm tracking-widest">WEF 2025</h4>
