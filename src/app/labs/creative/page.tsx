...
import { Image as ImageIcon, Video, Sparkles, Download, Eye, Wand2 } from 'lucide-react';
  ...
  const demos = [
    {
      ...
      image: '/images/labs/skyflex-demo.jpg',
    },
    {
      type: 'image',
      ...
      image: '/images/labs/cosmetic-demo.jpg',
    },
    {
      type: 'video',
      ...
      image: '/images/labs/fashion-demo.jpg',
    },
    {
      type: 'video',
      ...
      image: '/images/labs/realestate-demo.jpg',
    },
    {
      type: 'image',
      ...
      image: '/images/labs/food-demo.jpg',
    },
    {
      type: 'image',
      title: 'Tech Product',
      ...
      image: '/images/labs/tech-demo.jpg',
    },
  ];
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] rounded-3xl border-2 border-[#2a2a2a] p-8 md:p-12 mb-20">
              ...
              <div className="bg-black/40 rounded-2xl p-8 border border-[#2a2a2a]">
                <p className="text-white text-center mb-6">
                  Esta funcionalidad está integrada en nuestro sistema interno.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/contacto"
                    className="inline-flex items-center justify-center bg-white text-black font-semibold text-base py-3 px-8 rounded-full transition-all duration-200 hover:scale-105"
                  >
                    Solicitar acceso
                  </Link>
                  <Link
                    href="/servicios/ia-generativa"
                    className="inline-flex items-center justify-center bg-transparent text-white font-semibold text-base py-3 px-8 rounded-full border-2 border-white transition-all duration-200 hover:bg-white hover:text-black"
                  >
                    Ver servicios
                  </Link>
                </div>
