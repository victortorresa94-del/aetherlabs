    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-[#82ff1f] selection:text-black font-sans">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        ...
                        <div className="flex gap-4">
                            <span className="px-4 py-2 bg-white/5 border border-white/10 rounded text-sm text-zinc-300">100-150 leads/mes</span>
                            <span className="px-4 py-2 bg-white/5 border border-white/10 rounded text-sm text-zinc-300">5 Agentes</span>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
                    <div>
                        ...
                        <ul className="space-y-4 text-zinc-400">
                            <li className="flex items-center"><Home className="w-5 h-5 mr-3 text-zinc-600" /> Portales Inmobiliarios + Ads</li>
                            <li className="flex items-center"><Users className="w-5 h-5 mr-3 text-zinc-600" /> Seguimiento manual irregular</li>
                            <li className="flex items-center"><MapPin className="w-5 h-5 mr-3 text-zinc-600" /> Cartera de propiedades rotativa</li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-6 text-red-400 uppercase tracking-widest">Problema Habitual</h3>
                        <ul className="space-y-4 text-zinc-400">
                            <li className="flex items-start"><span className="text-red-500 mr-3">×</span> Gran cantidad de leads sin presupuesto claro o real.</li>
                            <li className="flex items-start"><span className="text-red-500 mr-3">×</span> Visitas improductivas ("Tourisimo inmobiliario").</li>
                            <li className="flex items-start"><span className="text-red-500 mr-3">×</span> Base de datos de compradores enfriada por falta de nurturing.</li>
                        </ul>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        ...
                        <div className="relative p-8 bg-black border border-white/10 rounded-2xl group hover:border-[#82ff1f] transition-colors">
                            ...
                            <h3 className="text-xl font-bold mb-4 mt-2">Ads por Zona</h3>
                            <p className="text-zinc-400 text-sm leading-relaxed mb-4">Campañas dirigidas a propiedades o zonas concretas para atraer interés específico, no genérico.</p>
                            <div className="text-xs text-zinc-500 font-mono bg-white/5 p-3 rounded">CAPTACIÓN DIRIGIDA</div>
                        </div>
                        ...
                        <div className="relative p-8 bg-black border border-white/10 rounded-2xl group hover:border-[#82ff1f] transition-colors">
                            ...
                            <h3 className="text-xl font-bold mb-4 mt-2">Agente "Álvaro"</h3>
                            <p className="text-zinc-400 text-sm leading-relaxed mb-4">Pregunta presupuesto, detecta urgencia temporal e identifica tipo de compra (inversión vs vivienda).</p>
                            <div className="text-xs text-zinc-500 font-mono bg-white/5 p-3 rounded">CUALIFICACIÓN REAL</div>
                        </div>
                        ...
                        <div className="relative p-8 bg-black border border-white/10 rounded-2xl group hover:border-[#82ff1f] transition-colors">
                            ...
                            <h3 className="text-xl font-bold mb-4 mt-2">CRM Clasificado</h3>
                            <p className="text-zinc-400 text-sm leading-relaxed mb-4">Pipeline: Nuevo &rarr; Cualificado (Hot/Warm) &rarr; Visita Programada &rarr; Negociación &rarr; Cerrado.</p>
                            <div className="text-xs text-zinc-500 font-mono bg-white/5 p-3 rounded">VISUALIZACIÓN DE NEGOCIO</div>
                        </div>
                        ...
                        <div className="relative p-8 bg-black border border-white/10 rounded-2xl group hover:border-[#82ff1f] transition-colors">
                            ...
                            <h3 className="text-xl font-bold mb-4 mt-2">Nurturing Auto</h3>
                            <p className="text-zinc-400 text-sm leading-relaxed mb-4">Seguimiento automático a los 7, 30 y 90 días con nuevas oportunidades. Reactivación de base de datos.</p>
                            <div className="text-xs text-zinc-500 font-mono bg-white/5 p-3 rounded">BAJO COSTE DE ADQUISICIÓN</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-6 bg-[#82ff1f] text-black text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">¿Gestionas activos o propiedades?</h2>
