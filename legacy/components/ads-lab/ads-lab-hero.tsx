...
const steps = [
    {
        ...
        title: "Define su Objetivo",
        description: "Tráfico, Conversión o Brand Awareness. La IA se adapta a tus KPIs.",
        status: "80% COMPLETO",
        progress: 80
    },
    {
        ...
        description: "Sube una foto o describe tu producto. La IA entiende qué vendes.",
        status: "80% COMPLETO",
        progress: 80
    },
    {
        ...
        description: "Cientos de creatividades en segundos con diferentes ángulos de venta.",
        status: "80% COMPLETO",
        progress: 80
    },
    {
        icon: <BarChart3 className="w-5 h-5" />,
        title: "Predice el Éxito",
        description: "Análisis de impacto y CTR predictivo antes de lanzar tu campaña.",
        status: "80% COMPLETO",
        progress: 80
    },
    {
        icon: <Rocket className="w-5 h-5" />,
        title: "Escala y Vence",
        description: "Despliega las mejores piezas directamente en tus plataformas de ads.",
...
const AdsLabHero = () => {
    const scrollToWizard = () => {
        const wizard = document.getElementById('ads-lab-wizard');
        if (wizard) {
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#82ff1f]">AETHER AI ADS LAB</span>
                        </div>
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-8 tracking-tight leading-tight">
                            Creatividades que <span className="text-[#82ff1f]">convierten</span> al instante.
                        </h2>

                        <p className="text-zinc-300 text-lg font-medium max-w-lg mb-10 leading-relaxed">
                            Genera variantes infinitas de anuncios optimizados para tus campañas. Diseña, prueba y escala tus creatividades con el poder de la IA.
                        </p>
